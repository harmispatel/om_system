                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label for="is_counter" class="form-label">Is_Counter? <span
                                                        class="text-danger">*</span></label>
                                                <input type="checkbox" id="is_counter" name="is_counter" value="1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3" id="select-box">
                                                <div class="form-group">
                                                    ...
                                                    <select type="text" name="order_value" class="form-control">
                                                        <option value="">--select value--</option>
                                                        <option value="C"
                                                            {{ old('order_value') == 'C' ? 'selected' : '' }}>C</option>
                                                        <option value="B"
                                                            {{ old('order_value') == 'B' ? 'selected' : '' }}>B</option>
                                                        <option value="R"
                                                            {{ old('order_value') == 'R' ? 'selected' : '' }}>R</option>
                                                        <option value="WH"
                                                            {{ old('order_value') == 'WH' ? 'selected' : '' }}>WH</option>
                                                        <option value="BC"
                                                            {{ old('order_value') == 'BC' ? 'selected' : '' }}>BC</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseother" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <label>
                                                                    <input type="checkbox" name="permission[]"
                                                                        value="{{ $value->id }}" class="mr-3">{{$value->name}}
                                                                    ...
                                                                    ISS.FOR.DELIVERY
                                                                    @elseif($value->name == 'req.for.delivery')
                                                                    REC.FOR.DELIVERY
                                                                    @elseif($value->name == 'iss.for.packing')
                                                                    ISS.FOR.PACKING
                                                                    @elseif($value->name == 'req.for.packing')
                                                                    REC.FOR.PACKING
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1"
                                                    id="flexCheckDefault" name="is_counter">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Is Counter Department ?
                                                </label>
                                                </div>
                                            </div>
                                        </div> -->
                                        <!-- <h3>Working Date<span class="text-danger">*</span></h3>
                                        <div class="row">
                                            <div class="col-md-3 form-group">
                                                <label>Start</label>
                                                <input
                                                    class="form-control-lg border border-dark w-100 {{  ($errors->has('StartDate')) ? 'is-invalid' : '' }}"
                                                    type="time" name="StartDate" id="date">
                                            ...
                                            <div class="col-md-3 form-group">
                                                <label>End</label>
                                                <input
                                                    class="form-control-lg border border-dark w-100 {{  ($errors->has('EndDate')) ? 'is-invalid' : '' }}"
                                                    type="time" name="EndDate" id="date">
